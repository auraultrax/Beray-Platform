...
import { READY_CURRICULUM } from "./curriculum.js";
...
function renderStudentCourses() {
    ...
    container.innerHTML =
        [...courses.map(makeCard), ...ready.map(renderReadyCurriculumCard)].join("")
        ||
        `
        <div class="card">
...
function renderStudentTests(
    ...
    let tests = studentState.tests.filter(test => {
        ...
        try {
            ...
            $("quizBox").innerHTML = `
                <div class="quiz-result">
                    ...
                    <p class="yellow-text">+${pointsAwarded} puan</p>
